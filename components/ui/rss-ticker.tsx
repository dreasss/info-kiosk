...
export function RssTicker({ className }: RssTickerProps) {
    ...
    const fetchRssNews = async () => {
      try {
        ...
        const mockNews: RssItem[] = [
          {
            title: "Ученые обнаружили новый тип черных дыр в центре галактики",
            link: "#",
            pubDate: new Date().toISOString(),
            source: "Naked Science",
          },
          {
            title: "Российские физики создали квантовый компьютер нового поколения",
            link: "#",
            pubDate: new Date(Date.now() - 3600000).toISOString(),
            source: "Naked Science",
          },
          {
            title: "Найден способ увеличить эффективность солнечных батарей на 40%",
            link: "#",
            pubDate: new Date(Date.now() - 7200000).toISOString(),
            source: "Naked Science",
          },
          {
            title: "Марсоход Perseverance обнаружил следы древней жизни на Марсе",
            link: "#",
            pubDate: new Date(Date.now() - 10800000).toISOString(),
            source: "Naked Science",
          },
          {
            title: "Новый метод лечения рака показал эффективность в 95% случаев",
            link: "#",
  ...
  return (
    <div className={cn("bg-gradient-to-r from-blue-600 to-blue-800 text-white py-3 overflow-hidden", className)}>
