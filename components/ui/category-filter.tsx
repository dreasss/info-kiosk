...
import { Building, Landmark, DoorOpen, Utensils, Music, Filter } from "lucide-react"
...
export function CategoryFilter({ onFilterChange, className }: CategoryFilterProps) {
  ...
  return (
    <div className={cn("bg-white/95 backdrop-blur-sm rounded-xl shadow-lg p-3 border border-white/20", className)}>
      <div className="flex items-center mb-3 px-1">
        <div className="p-1.5 bg-blue-100 rounded-lg mr-2">
          <Filter className="h-4 w-4 text-blue-600" />
        </div>
        <span className="text-sm font-semibold text-gray-800">Категории объектов</span>
      </div>
        ...
        >
          <div
            className={cn(
              ...
              activeCategory === "all" ? "bg-white/20" : "bg-gray-200 group-hover:bg-gray-300",
            )}
          >
          ...
          return (
            ...
            >
              <div
                ...
                style={!isActive ? { backgroundColor: `${category.color}20` } : undefined}
              >
                <Icon
