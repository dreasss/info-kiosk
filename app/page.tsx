        ...
        <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col">
          ...
          <div className="text-center mb-8 animate-fadeInUp" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
            ...
            <p
              ...
              suppressHydrationWarning={true}
            >
              {isClient && language === "en" ? "JINR Interactive Information System" : "Интерактивная информационная система ОИЯИ"}
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-6">
            <TouchButton
              ...
              touchSize="lg"
              style={{ animationDelay: '0s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(59, 130, 246, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />
            ...
            <TouchButton
              ...
              touchSize="lg"
              style={{ animationDelay: '0.1s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(147, 51, 234, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />
            ...
            <TouchButton
              ...
              touchSize="lg"
              style={{ animationDelay: '0.2s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(34, 197, 94, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />

            <TouchButton
              href="/infrastructure"
              icon={Building2}
              title={isClient && language === "en" ? "Infrastructure" : "Инфраструктура"}
          ...
          <div className="flex-1 mb-6 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
            <Card className="bg-white/90 backdrop-blur-md border border-white/20 shadow-2xl rounded-2xl overflow-hidden h-full hover:shadow-3xl transition-all duration-300 transform hover:scale-[1.01] card-hover">
              <div className="p-6">
                ...
                <h1
                  className="text-xl md:text-2xl lg:text-3xl font-bold text-white drop-shadow-md text-center tracking-tight leading-tight px-4"
                  suppressHydrationWarning={true}
                >
                  {isClient && language === "en"
                    ? "Joint Institute for Nuclear Research"
