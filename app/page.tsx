...
export default function HomePage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        setNews(newsData.slice(0, 5)) // Берем только 5 последних ново��тей
  ...
  useEffect(() => {
    if (
      ...
      // Добавляем функции в глобальную область для отл��дки
      ...
      console.log("  - window.dbForceReset() - Полное удаление и пересоздание БД");
    }
  }, []);
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                >
                  {getText("Joint Institute for Nuclear Research", "Объединенный Институт Ядерных Исследований")}
                </h1>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col">
          ...
          <div className="text-center mb-8 animate-fadeInUp" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
            ...
            <p
              ...
              suppressHydrationWarning={true}
            >
              {getText("JINR Interactive Information System", "Интерактивная информационная система ОИЯИ")}
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-6">
            <TouchButton
              ...
              touchSize="lg"
              style={{ animationDelay: '0.1s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(59, 130, 246, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />

            <TouchButton
              href="/gallery"
              icon={ImageIcon}
              title={getText("Gallery", "Галерея")}
              ...
              touchSize="lg"
              style={{ animationDelay: '0.2s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(147, 51, 234, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />

            <TouchButton
              href="/news"
              icon={Newspaper}
              title={getText("News", "Новости")}
              ...
              touchSize="lg"
              style={{ animationDelay: '0.3s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(34, 197, 94, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />

            <TouchButton
              href="/infrastructure"
              icon={Building2}
              title={getText("Infrastructure", "Инфраструктура")}
              ...
              touchSize="lg"
              style={{ animationDelay: '0.3s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(249, 115, 22, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />

            <TouchButton
              href="/events"
              icon={Calendar}
              title={getText("Events", "События")}
              ...
              touchSize="lg"
              style={{ animationDelay: '0.4s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(244, 63, 94, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />

            <TouchButton
              href="/about"
              icon={Info}
              title={getText("About", "О ОИЯИ")}
              ...
              touchSize="lg"
              style={{ animationDelay: '0.5s', animationFillMode: 'both', boxShadow: '0 20px 40px rgba(99, 102, 241, 0.3), 0 10px 20px rgba(0, 0, 0, 0.2)' }}
            />
            <div className="mb-8 animate-fadeInUp" style={{ animationDelay: '0.6s', animationFillMode: 'both' }}>
          ...
          <div className="flex-1 mb-6 animate-fadeInUp" style={{ animationDelay: '0.6s' }}>
            <Card className="bg-white/90 backdrop-blur-md border border-white/20 shadow-2xl rounded-2xl overflow-hidden h-full hover:shadow-3xl transition-all duration-300 transform hover:scale-[1.01] card-hover">
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-800 mb-6 flex items-center" suppressHydrationWarning={true}>
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center text-sm animate-fadeInUp" style={{ animationDelay: '0.8s', animationFillMode: 'both' }}>
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-2">
            <div className="flex items-center hover:scale-105 hover:bg-white/10 px-2 py-1 rounded-lg transition-all duration-300 cursor-pointer">
              ...
              <span>{isClient && language === "en" ? "Dubna, Moscow Region" : "г. Дубна, Московская область"}</span>
            </div>
            <div className="flex items-center hover:scale-105 hover:bg-white/10 px-2 py-1 rounded-lg transition-all duration-300 cursor-pointer">
              <span className="opacity-70 mr-2 text-lg">📞</span>
